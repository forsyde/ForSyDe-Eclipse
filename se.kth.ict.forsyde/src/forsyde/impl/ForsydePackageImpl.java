...
public class ForsydePackageImpl extends EPackageImpl implements ForsydePackage {
	 ...
	 * @generated
	 */
	public EReference getLeafProcess_Ports() {
	...
	public EReference getLeafProcess_ConstructorArguments() {
		return (EReference)leafProcessEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EReference getinputPort_BoundProcess() {
	 ...
	 * @generated
	 */
	public EReference getoutputPort_BoundProcess() {
	...
	public void createPackageContents() {
		...
		createEReference(leafProcessEClass, LEAF_PROCESS__PORTS);
		...
		createEReference(inputPortEClass, INPUT_PORT__BOUND_PROCESS);
		createEReference(inputPortEClass, INPUT_PORT__BOUND_PORT);

		outputPortEClass = createEClass(OUTPUT_PORT);
		createEReference(outputPortEClass, OUTPUT_PORT__BOUND_PROCESS);
	...
	public void initializePackageContents() {
		...
		initEReference(getLeafProcess_Ports(), this.getPort(), null, "ports", null, 1, -1, LeafProcess.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getSignal_SourcePort(), this.getPort(), null, "sourcePort", null, 1, 1, Signal.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getSignal_TargetPort(), this.getPort(), null, "targetPort", null, 1, 1, Signal.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getinputPort_BoundProcess(), this.getProcess(), null, "boundProcess", null, 0, 1, inputPort.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getoutputPort_BoundProcess(), this.getProcess(), null, "boundProcess", null, 0, 1, outputPort.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
