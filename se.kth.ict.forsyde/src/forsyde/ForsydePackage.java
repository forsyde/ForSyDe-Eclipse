...
public interface ForsydePackage extends EPackage {
	 ...
	 * @ordered
	 */
	int LEAF_PROCESS__PORTS = PROCESS_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int LEAF_PROCESS__PROCESS_CONSTRUCTOR = PROCESS_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int LEAF_PROCESS__CONSTRUCTOR_ARGUMENTS = PROCESS_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int LEAF_PROCESS_FEATURE_COUNT = PROCESS_FEATURE_COUNT + 3;
	 ...
	 * @ordered
	 */
	int INPUT_PORT__BOUND_PROCESS = PORT_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int INPUT_PORT__BOUND_PORT = PORT_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int OUTPUT_PORT__BOUND_PROCESS = PORT_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int OUTPUT_PORT__BOUND_PORT = PORT_FEATURE_COUNT + 1;
	...
	/**
	 * Returns the meta object for the containment reference list '{@link forsyde.LeafProcess#getPorts <em>Ports</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Ports</em>'.
	 * @see forsyde.LeafProcess#getPorts()
	 * @see #getLeafProcess()
	 * @generated
	 */
	EReference getLeafProcess_Ports();
	...
	/**
	 * Returns the meta object for the containment reference list '{@link forsyde.CompositeProcess#getPorts <em>Ports</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Ports</em>'.
	 * @see forsyde.CompositeProcess#getPorts()
	...
	/**
	 * Returns the meta object for the reference '{@link forsyde.inputPort#getBoundProcess <em>Bound Process</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Bound Process</em>'.
	 * @see forsyde.inputPort#getBoundProcess()
	 * @see #getinputPort()
	 * @generated
	 */
	EReference getinputPort_BoundProcess();
	...
	/**
	 * Returns the meta object for the reference '{@link forsyde.outputPort#getBoundProcess <em>Bound Process</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Bound Process</em>'.
	 * @see forsyde.outputPort#getBoundProcess()
	 * @see #getoutputPort()
	 * @generated
	 */
	EReference getoutputPort_BoundProcess();
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EReference LEAF_PROCESS__PORTS = eINSTANCE.getLeafProcess_Ports();
		 ...
		 * @generated
		 */
		EReference INPUT_PORT__BOUND_PROCESS = eINSTANCE.getinputPort_BoundProcess();
		 ...
		 * @generated
		 */
		EReference OUTPUT_PORT__BOUND_PROCESS = eINSTANCE.getoutputPort_BoundProcess();
