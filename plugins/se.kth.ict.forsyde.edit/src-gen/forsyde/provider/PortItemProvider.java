...
/**
 * This is the item provider adapter for a {@link forsyde.Port} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ForsydePackage.Literals.PORT__NAME,
				 true,
				 false,
				 false,
	...
	protected void addMocPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Port_moc_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Port_moc_feature", "_UI_Port_type"),
				 ForsydePackage.Literals.PORT__MOC,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ForsydePackage.Literals.PORT__DATA_TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addBoundProcessPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Port_boundProcess_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Port_boundProcess_feature", "_UI_Port_type"),
				 ForsydePackage.Literals.PORT__BOUND_PROCESS,
				 true,
				 false,
				 true,
				 null,
