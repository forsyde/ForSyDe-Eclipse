 ...
 *   <li>{@link forsyde.impl.PortImpl#getBoundProcess <em>Bound Process</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class PortImpl extends MinimalEObjectImpl.Container implements Port {
	...
	public forsyde.Process getBoundProcess() {
		if (boundProcess != null && boundProcess.eIsProxy()) {
			...
			if (boundProcess != oldBoundProcess) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ForsydePackage.PORT__BOUND_PROCESS, oldBoundProcess, boundProcess));
			}
		}
		return boundProcess;
	}
	...
	public void setBoundProcess(forsyde.Process newBoundProcess) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ForsydePackage.PORT__BOUND_PROCESS, oldBoundProcess, boundProcess));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ForsydePackage.PORT__DATA_TYPE:
				return getDataType();
			case ForsydePackage.PORT__BOUND_PROCESS:
